...
<html lang="en">
    <head>
        ...
        body
        {
        background-image:url('images/registeronline.png');
    ...
    <body><br>
        <div class="container">
            ...
            <hr><p>Notice: If your Email already exists, you cannot register again.</p>
            <p>Reset your password or register with different Email</p>
        </div>    
    </body>
</html>